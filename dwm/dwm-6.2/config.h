...
static const char  *dmu[] = { "dmenu_run",  NULL };
static const char  *vu[] = { "volumectl", "up", NULL };
static const char  *vd[] = { "volumectl", "down", NULL };
static const char  *td[] = { "todo", NULL };

static Key keys[] = {
        /* modifier                     key        function        argument */
        { MODKEY,                       XK_n,      spawn,          {.v = dmenucmd } },
        { MODKEY|ShiftMask,             XK_Up,      spawn,          {.v = vu } },
        { MODKEY|ShiftMask,             XK_Down,      spawn,          {.v = vd } },
        { MODKEY,                       XK_o,      spawn,          {.v = td } },
	...
	{ MODKEY|ShiftMask,             XK_u,      updateCS,    {0} },
